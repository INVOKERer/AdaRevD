...
parser.add_argument('--input_dir', default='GoPro/test/input_crops_384', type=str, help='Directory of validation images') # blur sharp_phase
parser.add_argument('--tar_dir', default='GoPro/test/target_crops_384', type=str, help='Directory of gt images') # sharp sharp_phase
parser.add_argument('--result_dir', default='./results/xxxs', type=str, help='Directory for results')

parser.add_argument('--weights',
                    default='ckpts/RevD-B/net_g_GoPro.pth',
