...
def main():
    ...
    #
    # opt['input_folder'] = '/home/ubuntu/106-48t/personal_data/mxt/Datasets/Denoise/SIDD_NAFNet/SIDD/SIDD-train/train'
    # opt['save_folder'] = '/home/ubuntu/106-48t/personal_data/mxt/Datasets/Denoise/SIDD_NAFNet/SIDD/train/input_crops'
    # opt['crop_size'] = 512
    # opt['step'] = 384
    # opt['thresh_size'] = 0
    # opt['keywords'] = '_NOISY'
    ...
    #
    # opt['save_folder'] = '/home/ubuntu/106-48t/personal_data/mxt/Datasets/Denoise/SIDD_NAFNet/SIDD/train/gt_crops'
    # opt['keywords'] = '_GT'
    # extract_subimages(opt)
