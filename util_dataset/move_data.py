...
check_root = r'/home/ubuntu/qlli-3090-2/mxt/DeFocus_company_defocus/train/sharp' # 106-48t/personal_data/mxt/Datasets/AutoFocus/20211101 Data1/mxt/AutoFocus/20211101
move_dir = r'/home/ubuntu/qlli-3090-2/mxt/DeFocus_company_defocus/train/blur'
out_dir = '/home/ubuntu/qlli-3090-2/mxt/DeFocus_company_defocus/blank'
# print(check_root)
print(check_root)
...
for i in tqdm.tqdm(move_list):
    ...
    if file_name_y not in images_check:
        # print(file_name_y, i, y)
        out_path = os.path.join(out_dir, y)
        ml2 = 'sudo mv ' + i + ' ' + out_path
        # print(ml2)
        os.system(ml2)
        # ml1 = 'sudo rm ' + i
        # os.chmod(i, 0o777)
